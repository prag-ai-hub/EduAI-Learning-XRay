...
async function downloadAssessmentZip(assessment:Assessment,result:GradeResult,guide?:Worksheet,worksheet?:Worksheet){
  ...
  if(missing.length)files[folder+"Missing_Files.txt"]=strToU8(`These files have not been generated yet: ${missing.join(", ")}. Generate them in Learning X-Ray, then download the ZIP again.`);
