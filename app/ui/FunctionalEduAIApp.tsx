...
async function downloadCorrectedAnswerSheet(assessment:Assessment,result:GradeResult,file:UploadFile){
  ...
  for(let index=0;index<questions.length;index++){
    if(index)pdf.addPage();const question=questions[index],pageNumber=Math.max(1,Number(question.pageNumber)||1);
    ...
    pdf.setFont("helvetica","normal");pdf.setFontSize(9);pdf.setTextColor(90,102,122);pdf.text(`${result.studentName} · Class ${assessment.grade}${assessment.section} · ${assessment.subject}`,14,37);
